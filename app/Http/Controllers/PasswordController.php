    ...
    */
    ...
    {   
        try {
            ...
            Mail::to($user)->send(new UserResetPasswordMail($user, $userToken));
        ...
        // dd($request);
        return redirect()->route('password_reset.email.send_completed');
    }
